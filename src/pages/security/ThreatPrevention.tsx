...
export const ThreatPrevention: React.FC = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Threat Prevention</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <h2 className="text-lg font-semibold mb-4">Attack Categories</h2>
      ...
      <div className="mt-8 bg-white p-4 rounded-lg shadow">
        <h2 className="text-lg font-semibold mb-4">Signature Coverage</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <p className="text-sm text-gray-600">Active Signatures</p>
            <p className="text-xl font-semibold">
              {ipsMetrics.signature_coverage.active_signatures.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-sm text-gray-600">Custom Signatures</p>
            <p className="text-xl font-semibold">
